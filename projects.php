                        ...
                        <div class="services-s3-grids">
                            <div class="grid">
                                <div class="inner">
                                    ...
                                    <div class="details">
                                        <h3><a href="air-filter.php">Air Filters</a></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="grid">
                            ...
                            <div class="grid">
                                <div class="inner">
                                    <div class="img-holder">
                                        <img src="assets/images/services-s3/img-3.jpg" alt>
                                    </div>
                                    <div class="details">
                                        <h3><a href="#">Piping materials</a></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="grid">
                                <div class="inner">
                                    <div class="img-holder">
                                        <img src="assets/images/services-s3/img-4.jpg" alt>
                                    </div>
                                    <div class="details">
                                        <h3><a href="#">Industrial Process Heating</a></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="grid">
                                <div class="inner">
                                    <div class="img-holder">
                                        <img src="assets/images/services-s3/img-5.jpg" alt>
                                    </div>
                                    <div class="details">
                                        <h3><a href="#">HVAC Equipment</a></h3>
                                    </div>
                                </div>
                            </div>
                            <div class="grid">
                                <div class="inner">
                                    <div class="img-holder">
                                        <img src="assets/images/services-s3/img-6.jpg" alt>
                                    </div>
                                    <div class="details">
                                        <h3><a href="#">UPS Components</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="projects-grid-view">
                            <div class="grid" style="height: 400px;">
                                <div class="project-img" >
                                    <img src="assets/images/projects/filters.png" alt>
                                </div>
                                <div class="project-info">
                                    <div class="inner-info">
                                        <a href="air-filter.php"><h3>Air Filters</h3></a>
                                        <div class="tags">Production of air filters</div>
                                    </div>
                                </div>
                            </div>
                            <div class="grid" style="height: 400px;">
                                <div class="project-img" style="height: 400px;">
                                    <img src="assets/images/projects/safety.jpg" alt>
                                </div>
                                <div class="project-info">
                                    <div class="inner-info">
